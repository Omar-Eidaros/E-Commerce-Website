<%-- 
    ...
    Created on : Mar 22, 2022, 6:04:40 PM
    Author     : Salma
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicon -->
        <link rel="apple-touch-icon" sizes="180x180" href="/TechStore2/assets/images/icons/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/TechStore2/assets/images/icons/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/TechStore2/assets/images/icons/favicon-16x16.png">
        <link rel="manifest" href="/TechStore2/assets/images/icons/site.html">
        <link rel="mask-icon" href="/TechStore2/assets/images/icons/safari-pinned-tab.svg" color="#666666">
        <link rel="shortcut icon" href="/TechStore2/assets/images/icons/favicon.ico">
        <meta name="apple-mobile-web-app-title" content="Molla">
        <meta name="application-name" content="Molla">
        <meta name="msapplication-TileColor" content="#cc9966">
        <meta name="msapplication-config" content="/TechStore2/assets/images/icons/browserconfig.xml">
        <meta name="theme-color" content="#ffffff">
        <!-- Plugins CSS File -->
        <link rel="stylesheet" href="/TechStore2/assets/css/bootstrap.min.css">
        <!-- Main CSS File -->
        <link rel="stylesheet" href="/TechStore2/assets/css/style.css">
                    ...
                    <div class="container">
                        <div class="header-left">
                            ...
                            <a href="index.html" class="logo">
                                <img src="/TechStore2/assets/images/logo.png" alt="Molla Logo" width="105" height="25">
                            </a>
                                            ...
                                            <div class="menu-col">
                                                ...
                                                <div class="demo-list">
                                                    <div class="demo-item">
                                                        <a href="index-1.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/1.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-2.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/2.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-3.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/3.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-4.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/4.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-5.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/5.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-6.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/6.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-7.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/7.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-8.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/8.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-9.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/9.jpg);"></span>
                                                    ...
                                                    <div class="demo-item">
                                                        <a href="index-10.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/10.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-11.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/11.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-12.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/12.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-13.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/13.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-14.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/14.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-15.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/15.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-16.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/16.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-17.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/17.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-18.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/18.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-19.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/19.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-20.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/20.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-21.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/21.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-22.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/22.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-23.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/23.jpg);"></span>
                                                    ...
                                                    <div class="demo-item hidden">
                                                        <a href="index-24.html">
                                                            <span class="demo-bg"
                                                                  style="background-image: url(/TechStore2/assets/images/menu/demos/24.jpg);"></span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="/TechStore2/assets/images/menu/banner-1.jpg" alt="Banner">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html">
                                                            <img src="/TechStore2/assets/images/menu/banner-2.jpg" alt="Banner">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="/TechStore2/assets/images/products/cart/product-1.jpg" alt="product">
                                                </a>
                                            </figure>
                                            <a href="#" class="btn-remove" title="Remove Product"><i
                                                    class="icon-close"></i></a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="/TechStore2/assets/images/products/cart/product-2.jpg" alt="product">
                                                </a>
                                            </figure>
                                            <a href="#" class="btn-remove" title="Remove Product"><i
                                                    class="icon-close"></i></a>
                                ...
                                <ul class="nav nav-pills nav-fill" role="tablist" style="user-select: auto;">
                                    <li class="nav-item" style="user-select: auto;">
                                        <a class="nav-link active" id="signin-tab-2" data-toggle="tab" href="#signin-2" role="tab"
                                           aria-controls="signin-2" aria-selected="true" style="user-select: auto;">Code Valdation</a>
                                    </li>
                                    ...
                                    <div class="tab-pane fade active show" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2"
                                        ...
                                        <form action="#" style="user-select: auto;">
                                            <div class="form-group"
                                                ...
                                                <label for="singin-email-2" style="user-select: auto;"></label>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget widget-about">
                            <img src="/TechStore2/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105"
                                 height="25">
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <figure class="footer-payments">
                    <img src="/TechStore2/assets/images/payments.png" alt="Payment methods" width="272" height="20">
                        ...
                        <div class="tab-content" id="tab-content-5">
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <form action="#">
                                    ...
                                    <div class="form-footer">
                                        <button type="submit" class="btn btn-outline-primary-2" onclick="chkErr()">
                                            <span>SIGN UP</span>
                                            <i class="icon-long-arrow-right"></i>
                                        </button>
...
<!-- Plugins JS File -->
<script src="/TechStore2/assets/js/jquery.min.js"></script>
<script src="/TechStore2/assets/js/bootstrap.bundle.min.js"></script>
<script src="/TechStore2/assets/js/jquery.hoverIntent.min.js"></script>
<script src="/TechStore2/assets/js/jquery.waypoints.min.js"></script>
<script src="/TechStore2/assets/js/superfish.min.js"></script>
<script src="/TechStore2/assets/js/owl.carousel.min.js"></script>
<!-- Main JS File -->
<script src="/TechStore2/assets/js/main.js"></script>
