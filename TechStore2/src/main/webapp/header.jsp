...
=======
    ...
    <%
        ...
        if (loggedIn == null || loggedIn.equalsIgnoreCase("false")) {
            loginStatus = false;
                        ...
                        <div class="header-right">
                            ...
                            <nav class="main-nav">
                                <ul class="menu sf-arrows">
                                    ...
                                    <% if (loginStatus) {
                                    %>
                                    <li><a href="LogoutUser"><i class="icon-user" style="user-select: auto;"></i>LogOut</a></li>
...
>>>>>>> 4d9696db4bfbb4b3b7abe28011307716caf31abc
