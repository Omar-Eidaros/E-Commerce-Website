<%-- 
    Document   : login
    Created on : Mar 20, 2022, 5:14:36 AM
    Author     : Omar Samir
--%>
                                    ...
                                    <div class="tab-pane fade show active reg" id="register-2" role="tabpanel"
                                        ...
                                        <form action="#">
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="email">values cannot be left empty</p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="pass">password is week shouldn't be less than 8
                                                    characters</p>
                                            </div><!-- End .form-group -->
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="phone"> values cannot be left empty</p>
                                            </div><!-- End .form-group -->
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="bdate"> you have to enter your birth date</p>
                                            </div><!-- End .form-group -->
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="address"> values cannot be left empty</p>
                                            </div><!-- End .form-group -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="error" id="job">you have to enter your job</p>
                                            </div><!-- End .form-group -->
                                            <div class="form-group">
                                                ...
                                                <div class="form_wrap ">
                                                    <div class="checkbox">
                                                        ...
                                                        <input type="checkbox" id="calorieCheckbox" value="smart phones"
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        <input type="checkbox" id="saltCheckbox" value="smart watches"
                                                               name="interests">smart
                                                        watches
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        <input type="checkbox" id="saltCheckbox" value="laptobs"
                                                ...
                                                <p class="error" id="interests">you should choose at least one</p>
                                            </div>
                                            <div class="form-footer">
                                                <button type="submit" class="btn btn-outline-primary-2">
                                                    <span>SIGN UP</span>
